...
export let SampleLibrary = {
    ...
    list: ['bassdrum','bass-electric','bassoon','cello','clarinet','contrabass','flute','french-horn','guitar-acoustic','guitar-electric','guitar-nylon', 'harmonium','harp','organ','piano','saxophone','snaredrum','trombone','trumpet','tuba','violin','xylophone'],
    onload: null,
